...
if __name__ == '__main__':
    ...
    root_dir    = '/Users/relu/data/benchmark_images/faceu/face_landmark/'
    imageDirs   = os.path.join(root_dir, 'WFLW/wflw_images')
    Mirror_file = os.path.join(root_dir, 'WFLW/wflw_anno/Mirror98.txt')

    landmarkDirs = ['WFLW/wflw_anno/raw_anno_test.txt',
                    'WFLW/wflw_anno/raw_anno_train.txt']
    ...
    for landmarkDir, outDir in zip(landmarkDirs, outDirs):
        ...
        if 'test' in landmarkDir:
            ...
            is_train = True
        landmarkDir = os.path.join(root_dir, landmarkDir)
